/**
  ...
  ******************************************************************************
  */
#ifndef AI_TINYCNNBUOW_H
#define AI_TINYCNNBUOW_H
...
#define AI_TINYCNNBUOW_ORIGIN_MODEL_NAME   "buow_tinycnn"

/******************************************************************************/
#define AI_TINYCNNBUOW_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TINYCNNBUOW_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TINYCNNBUOW_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TINYCNNBUOW_IN_NUM        (1)

AI_DEPRECATED
#define AI_TINYCNNBUOW_IN \
  ai_tinycnnbuow_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYCNNBUOW_IN_SIZE { \
  AI_TINYCNNBUOW_IN_1_SIZE, \
}
#define AI_TINYCNNBUOW_IN_SIZE_BYTES { \
  AI_TINYCNNBUOW_IN_1_SIZE_BYTES, \
}
#define AI_TINYCNNBUOW_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINYCNNBUOW_IN_1_HEIGHT      (1)
#define AI_TINYCNNBUOW_IN_1_WIDTH       (64)
#define AI_TINYCNNBUOW_IN_1_CHANNEL     (258)
#define AI_TINYCNNBUOW_IN_1_SIZE        (16512)
#define AI_TINYCNNBUOW_IN_1_SIZE_BYTES  (66048)

/******************************************************************************/
#define AI_TINYCNNBUOW_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TINYCNNBUOW_OUT \
  ai_tinycnnbuow_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYCNNBUOW_OUT_SIZE { \
  AI_TINYCNNBUOW_OUT_1_SIZE, \
}
#define AI_TINYCNNBUOW_OUT_SIZE_BYTES { \
  AI_TINYCNNBUOW_OUT_1_SIZE_BYTES, \
}
#define AI_TINYCNNBUOW_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINYCNNBUOW_OUT_1_CHANNEL     (6)
#define AI_TINYCNNBUOW_OUT_1_SIZE        (6)
#define AI_TINYCNNBUOW_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_TINYCNNBUOW_N_NODES (17)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tinycnnbuow
 ...
 * @ref ai_tinycnnbuow_create. Both the activations memory buffer 
 ...
 * using @ref ai_tinycnnbuow_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinycnnbuow_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinycnnbuow_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TINYCNNBUOW_*
 * defines into file @ref tinycnnbuow.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tinycnnbuow_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TINYCNNBUOW_H */
